...
UPDATE HOSPITAL
SET QTAT_LLITS=(SELECT SUM(S.QTAT_LLITS) FROM SALA S JOIN HOSPITAL H ON S.HOSPITAL_COD=H.HOSPITAL_COD WHERE S.HOSPITAL_COD=H.HOSPITAL_COD)
WHERE HOSPITAL_COD=SALA.HOSPITAL_COD;
